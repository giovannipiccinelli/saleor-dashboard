      ...
      <CardContent>
        <div className={classes.skuInputContainer}>
          <TextField
            ...
            label={intl.formatMessage({
              defaultMessage:
                "SKU (identificativo univoco: es. ST_1, ST_2 etc.)"
            })}
            name="sku"
        ...
        <ControlledCheckbox
          ...
          label={
            <>
              <FormattedMessage
                defaultMessage="Gestione di Magazzino"
                description="product inventory, checkbox"
              />
              <Typography variant="caption">
                <FormattedMessage defaultMessage="Gestisci attivamente il tuo inventario con STORITALIA" />
              </Typography>
            </>
          }
        />
              ...
              <TableRow>
                <TableCell colSpan={2}>
                  <Typography variant="body2">
                    <FormattedMessage
                      defaultMessage="Seleziona Magazzino"
                      description="button"
                    />
                  </Typography>
                </TableCell>
